...
data_df = comsol_to_h5.read_from_comsol_native_csv("/scratch/n/Natan.Dominko/comsol_data/logistic_t_1e6_eps_1e1.txt")
...
comsol_to_h5.write_data_to_h5(data_df, "/scratch/n/Natan.Dominko/h5_data/logistic_t_1e6_eps_1e1.h5")
